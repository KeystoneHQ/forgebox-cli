...
ForgeBox Hardware Wallet Management Tool. This tool is used for generating secure credentials, managing hardware device public key registration, and performing signature verification.
...
This will generate the `mh1903_full.bin` file in the `ForgeBox_cli/my-firmware` directory. This is the complete Keystone 3 Pro firmware. Next, we will sign this firmware.
